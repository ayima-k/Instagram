...
export const createPostImages = (data, accessToken) => axios.post('images/', data, headers(accessToken))
...
export const confirmRequest = (id, data, accessToken) => axios.put(`follow/${id}/`, data, headers(accessToken))
