...
import { AiFillHeart, AiFillHome, AiOutlineHeart, AiOutlineHome, AiOutlinePlusSquare } from 'react-icons/ai'
    ...
    <div className='sidebar_container'>
      <div className='main'>
          ...
          isMobile && (
            <div className="navbar">
              ...
              <div className="searchBlock">
                ...
                <div onClick={() => setActive('notif')} className={active === 'notif' ? 'div active' : 'div'}>
        ...
        <div className={search || notif ? 'sidebar new' : "sidebar"}>
          {
            !isMobile && <div className="logo" onClick={() => {
              navigate('/')
              setActive('home')
            }}>
              {isTablet || search || notif ? <BsInstagram/> : <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/2/2a/Instagram_logo.svg/840px-Instagram_logo.svg.png" alt="instagram" />}
            </div>
          }
          <div className="menus">
            <div
