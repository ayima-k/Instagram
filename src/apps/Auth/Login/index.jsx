    ...
    getUser()
      .then((r) => {
        localStorage.setItem(
          'user',
          JSON.stringify(r.data.find((obj) => obj.username === data.username)),
        );
        getToken({ username: data.username, password: data.password }).then((r) => {
          if (r) {
      ...
      <div className="login">
        {isTablet && (
          <div className="image_container">
            <img
              className="main_login_image"
              src="https://nimage.g-enews.com/phpwas/restmb_allidxmake.php?idx=5&simg=20220906105834056786ed0c62d4912242222121.jpg"
              alt=""
            />
          </div>
        )}
        <div className="login_container">
          <div className="container">
            ...
            <form onSubmit={handleSubmit(onSubmit)}>
              ...
              <div className="btn">
                <button
                  disabled={!isValid || passValue.length <= 8}
                  type="submit"
          ...
          <div className="login_footer">
            ...
            <div>
              <img
                onClick={() =>
                  (window.location.href =
                    'https://play.google.com/store/apps/details?id=com.instagram.android&referrer=utm_source%3Dinstagramweb%26utm_campaign%3DloginPage%26ig_mid%3D8CB32E45-78BF-4302-BD10-B3E2AD69FC6D%26utm_content%3Dlo%26utm_medium%3Dbadge')
                }
              ...
              <img
                onClick={() =>
                  (window.location.href =
                    'ms-windows-store://pdp/?productid=9nblggh5l9xt&referrer=appbadge&source=www.instagram.com&mode=mini&pos=0%2C0%2C1229%2C655')
                }
